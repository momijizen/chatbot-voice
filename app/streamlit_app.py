...
if query:
    ...
    prompt = f"""คุณคือผู้ช่วย AI ที่ฉลาดและให้คำตอบอย่างมั่นใจ

คำถาม: {query}

โปรดตอบคำถามนี้อย่างชัดเจน กระชับ และเป็นธรรมชาติ โดยใช้ข้อมูลที่เกี่ยวข้องจากบริบทต่อไปนี้:
{context}

หากไม่มีข้อมูลที่ตรงจากบริบท ใช้ความรู้ทั่วไปของคุณในการตอบอย่างถูกต้องที่สุด
"""
